...
init();
function init(){upgradeState();ensureDefaultBank();bindNav();bindEvents();bindDashboardStudyPanel();renderBankSelect();renderAll();setupEnhancedDataToolsV23();}
