...
- **Android 原生 Compose 版**：Kotlin + Compose 原生实现，当前主开发线，暗夜模式、AI 解析、背题模式、斩题功能、智能复习、错题复盘等增强功能均已落地。
...
- Web 版：`v0.4.6-alpha`
- 原生 Compose 版：`v0.5.8-native`

`v0.5.x-native` 阶段的原生版重点包含：智能复习模式、题目收藏与快速编辑、字号缩放与紧凑选项、批量自动切题、顺序练习进度记忆、首页紧凑布局兜底、练习页布局优化、危险操作二次确认、阅读显示偏好、构建缓存等。
