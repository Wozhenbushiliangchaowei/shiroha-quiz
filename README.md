...
`v0.4.8-native` 这一阶段的原生版重点包含：长选项完整显示、连续答对 2 次掌握、背题模式、斩题功能、即时判题/自动下一题拆分、跨端图片题库兼容和二级页面系统返回优化。
